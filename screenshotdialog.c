  ...
  if (strcmp (app_id, "") != 0)
    {
      ...
      heading = g_strdup_printf ("Share this screenshot with %s ?", g_app_info_get_display_name (info));
    }
  else
    heading = g_strdup ("Share this screenshot with the requesting application ?");
